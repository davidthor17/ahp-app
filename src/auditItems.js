...
export const SECTIONS = [
  ...
  { id: 'room', label: 'Room Quality', icon: '□', facility: null, items: [
    ...
    { id: 'RM-10', label: 'Minibar cleared/reset since last guest', minStars: 4, requires: 'hasMinibar' },
  ]},
  { id: 'facilities', label: 'Facilities', icon: '⚙', facility: null, items: [
    ...
    { id: 'FAC-04', label: 'Gym equipment modern and well maintained', minStars: 4, requires: 'hasGym' },
    { id: 'FAC-05', label: 'Gym access cost clearly disclosed (free or paid)', minStars: 4, requires: 'hasGym' },
    { id: 'FAC-06', label: 'Gym has a view or pleasant environment', minStars: 5, requires: 'hasGym' },
  ]},
  ...
  { id: 'lunch', label: 'Lunch & All-Day Dining', icon: '◑', facility: 'hasRestaurant', items: [
    ...
    { id: 'LUN-02', label: 'Food fresh — not reheated or tired', minStars: 4, requires: 'hasLunchService' },
  ...
  { id: 'pool', label: 'Pool', icon: '≈', facility: 'hasPool', items: [
    ...
    { id: 'PL-03', label: 'Sanitiser levels within acceptable range', minStars: 4 },
  ...
  { id: 'spa', label: 'Spa & Wellness', icon: '✦', facility: 'hasSpa', items: [
    ...
    { id: 'SP-02', label: 'Locker rooms clean and well-stocked', minStars: 4, requires: 'hasChangingRooms' },
    { id: 'SP-03', label: 'No hair in drains', minStars: 4, requires: 'hasChangingRooms' },
    { id: 'SP-04', label: 'Sauna functioning properly', minStars: 4, requires: 'hasSauna' },
